<template>
    <div class="w-full min-h-dvh"
        ...
        <div class="w-full pt-[70px] md:pl-[250px] flex"
        ...
        >
            ...
            <div class="w-full p-4 bg-main-bg dark:bg-gray-800"
                ...
                <div class="md:p-8 p-2 rounded-[16px] dark:border-[1px] dark:border-grey-600 bg-white dark:bg-gray-800 shadow-md dark:shadow-none"
                >
                ...
                <div class="md:h-[448px] mt-4 bg-white dark:bg-gray-800 md:flex ">
                    <div class="md:w-[381px] p-6 shrink-0 rounded-[16px] bg-white dark:bg-gray-800 shadow-md dark:border-[1px] dark:border-grey-600 bg-white dark:bg-gray-800 shadow-md dark:shadow-none"
                    >
                        <ListItem headerList="Latest Customers" :items="mainStore.clients"/>
                    </div>
                    <div class="md:w-full md:ml-4 ml-0 p-6 md:mt-0 mt-4 rounded-[16px] bg-white dark:bg-gray-800 shadow-md dark:border-[1px] dark:border-grey-600 bg-white dark:bg-gray-800 shadow-md dark:shadow-none"
                    >
                ...
                >
                    ...
                    <div class="">
                        <table class="table-auto w-full">
                            <thead>
                            <tr class="bg-main-bg border-b-[1px]">
                            ...
                            <tbody>
                            <tr class="dark:bg-grey-400" v-for="(transaction, index) in mainStore.transactions"
                                :key="index"
                                :class="{'bg-main-bg': index % 2 !== 0,'dark:bg-grey-100': index % 2 !== 0}"
                            >
